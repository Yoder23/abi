...
`ABI_CAPABILITY_COMPILER_CAMPAIGN_STATE_V10.json` is the live state. The
read-only R1-R3 diagnostic is complete; training, altered-checkpoint
persistence, final access, and promotion remain prohibited until a successor
