...
gates. `ABI_CAPABILITY_COMPILER_CAMPAIGN_STATE_V67.json` records live status.
...
| 3 | Causal teacher-to-target acquisition | UNCERTIFIED; V45 ROUTER QUALIFIED, V47/V49 GENERATOR FIT LIMITED |
