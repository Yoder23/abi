...
gates. `ABI_CAPABILITY_COMPILER_CAMPAIGN_STATE_V38.json` records live status.
...
| 3 | Causal teacher-to-target acquisition | UNCERTIFIED; V34 REPRESENTATION PASS, HOST CONFORMANCE NEXT |
