...
gates. `ABI_CAPABILITY_COMPILER_CAMPAIGN_STATE_V8.json` records live status.
...
| 3 | Causal teacher-to-target acquisition | TWO BRANCHES FAILED; COMPONENT DIAGNOSTIC PREREGISTERED; PHASE UNCERTIFIED |
