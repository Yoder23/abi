...
gates. `ABI_CAPABILITY_COMPILER_CAMPAIGN_STATE_V69.json` records live status.
...
| 3 | Causal teacher-to-target acquisition | UNCERTIFIED; V45 ROUTER QUALIFIED, V50/V51 CURRENT TOPOLOGY/DATA BRANCH CLOSED |
