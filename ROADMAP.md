...
gates. `ABI_CAPABILITY_COMPILER_CAMPAIGN_STATE_V11.json` records live status.
...
| 3 | Causal teacher-to-target acquisition | SHARED-OUTPUT SUCCESSOR PREREGISTERED; PHASE UNCERTIFIED |
