...
gates. `ABI_CAPABILITY_COMPILER_CAMPAIGN_STATE_V72.json` records live status.
...
| 3 | Causal teacher-to-target acquisition | UNCERTIFIED; V54 UTF-8-BPE POINTER SCREEN PREREGISTERED |
