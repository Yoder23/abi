...
gates. `ABI_CAPABILITY_COMPILER_CAMPAIGN_STATE_V10.json` records live status.
...
| 3 | Causal teacher-to-target acquisition | TWO BRANCHES FAILED; COMPONENT DIAGNOSTIC COMPLETE; PHASE UNCERTIFIED |
