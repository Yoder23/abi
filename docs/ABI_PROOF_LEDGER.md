...
| ABI-C4h | ABI can extract teacher-derived compositional English realization into a teacher-absent package | R17 public v1 source gate reached 66/120 exact; compiler was not invoked | Open; v1 source interface failed |
