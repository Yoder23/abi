...
| ABI-C4 | One source-acquired package can be pasted into frozen heterogeneous hosts and execute with zero host training | Not connected end-to-end by R7; R10 target | Open |
...
R10 may promote only ABI-C4. Even a perfect R10 result cannot promote ABI-C5,
ABI-C6, ABI-C7, or ABI-C8. Native transplantation remains a separate research
line; English/domain acquisition remains a separate teacher-quality line.
