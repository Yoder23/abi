"""Bind frozen R91 and passing native-source R94 evidence."""
...
def main() -> int:
    ...
    if source.get("verdict") != "PASS_R94_SOURCE" or source.get("candidate_accessed") is not False or source.get("layercake_loaded") is not False or not all(source.get("gates", {}).values()) or source_claim != evidence_hash(unsigned):
        parser.error("R94 source is absent, failed, or unrecomputable")
    paths = {
        ...
        "screen_wrapper": root / "experiments/native_source_span_r94/screen_v1.py",
        "protocol": root / "experiments/native_source_span_r94/PROTOCOL.md",
        "builder": root / "experiments/native_source_span_r94/build_catalog_v1.py",
        "source_scorer": root / "experiments/native_source_span_r94/score_source_v1.py",
    }
    value = {
        "format": "abi-r94-native-source-candidate-binding/1",
