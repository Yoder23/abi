"""Fail-closed R70 catalog shape and historical-overlap verifier."""
...
def main() -> int:
    ...
    result = {
        "format": "abi-r70-reasoning-catalog-verification/1",
    ...
    if args.output.exists():
        raise SystemExit("R70 verification output already exists")
