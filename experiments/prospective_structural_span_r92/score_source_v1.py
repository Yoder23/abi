"""Score the R92 source before any R91 candidate access."""
...
def main() -> int:
    ...
    if (
        ...
        parser.error("R92 source input, implementation, or output state changed")
    ...
    result["campaign"] = "r92"
    result["format"] = "abi-r92-prior-corrected-source-score/1"
    ...
    result["verdict"] = "PASS_R92_SOURCE" if all(result["gates"].values()) else "FAIL_R92_SOURCE"
