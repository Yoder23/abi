...
```powershell
$config = "experiments/neural_isa_r9/configs/preregistered_v1.json"
$out = "results/neural_isa_r9/revision_001/capability_specific_pythia"
...
The run command refuses an existing output directory. The verifier fails closed
