"""Fail-closed R68 catalog shape and historical-overlap verifier."""
...
def main() -> int:
    ...
    result = {
        "format": "abi-r68-reasoning-catalog-verification/1",
    ...
    if args.output.exists():
        raise SystemExit("R68 verification output already exists")
