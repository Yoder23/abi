"""Seal R16 using the additive all-artifact verifier and hostile audit."""
...
def seal_v2(
    ...
    certificate = {
        "format": "abi-r16-bounded-certificate/2",
        "repair_of": "results/factual_semantic_r16/heldout_v1_certificate.json",
        "verdict": "PASS",
        "claim": strict["claim"],
        ...
        "information_accounting": receipt["information_accounting"],
...
def main() -> None:
    ...
    result = seal_v2(args.config, args.reveal, args.run_dir, args.strict, args.live, args.hostile)
