"""Fail-closed R69 catalog shape and historical-overlap verifier."""
...
def main() -> int:
    ...
    result = {
        "format": "abi-r69-reasoning-catalog-verification/1",
    ...
    if args.output.exists():
        raise SystemExit("R69 verification output already exists")
