"""Fail-closed verifier for prospective R80 and prior-catalog disjointness."""
...
R80_SHA256 = "5c2975520630fd6cc1b57e473c50ed89e43540fb5e810ade91fba70c9b98b894"
PRIOR = {
...
def main() -> int:
    ...
    if sha256_file(args.catalog) != R80_SHA256:
        raise VerificationError("R80 catalog hash changed")
    catalog = load_probe_catalog(args.catalog)
    checks = _verify_rows(catalog, campaign="r80", split="validation", rows=1_400)
    ...
    if prior_prompt_overlap or prior_stem_overlap:
        raise VerificationError("R80 overlaps R76/R77 prompts or stems")
    result = {
        "format": "abi-r80-prospective-catalog-verification/1",
        "verdict": "PASS_R80_FROZEN_BEFORE_SOURCE_OR_CANDIDATE_ACCESS",
        "catalog_sha256": R80_SHA256,
        "checks": checks,
