...
Phase 0 is complete, Phase 1 is complete, and Phase 2 is preregistered and in
progress. No Phase 2 training result existed when its implementation hashes
were frozen.
...
The frozen implementation includes T0, L0, L1, D0, D1, the bounded D2 rule,
the exact 11,060,800-parameter same-size student, source-file rehashing,
