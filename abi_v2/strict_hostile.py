...
def run(root: Path) -> dict[str, Any]:
    ...
    causal_rows = Path(
        "results/abi_final_validation_v2/live_causality_r7_source_bound/qwen2/observations.jsonl"
    )
    ...
    manifest_target = root / "results/abi_final_validation_v2/live_causality_r7_source_bound/qwen2/manifest.json"
    ...
    causal_base = root / "results/abi_final_validation_v2/live_causality_r7_source_bound/qwen2"
    ...
    result = {
        "format": "abi-v2-strict-hostile-verification/5",
