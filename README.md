...
The authoritative state is `ABI_CAPABILITY_COMPILER_CAMPAIGN_STATE_V597.json`.
...
for one seed, not yet across all three; seeds 130363 and 155921 remain required.
Phase 2 and Phase 3
