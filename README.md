...
The next phase is **Phase 0 of the capability-compiler campaign: definitions,
strong matched baselines, and preregistration**. Normalized transfer-corpus
construction is Phase 1. No current ABI artifact is certified as a broadly
fluent teacher-derived LayerCake English core.
